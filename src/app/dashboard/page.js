      ...
      <main>
        <div className="p-6 sm:p-12 dark:bg-gray-900 dark:text-gray-100">
          <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
            <img src="https://source.unsplash.com/75x75/?portrait" alt="" className="self-center flex-shrink-0 w-24 h-24 border rounded-full md:justify-self-start dark:bg-gray-500 dark:border-gray-700" style={{ width: "15rem", height: "15rem" }} />
            <div className="flex flex-col">
              <h4 className="text-lg font-semibold text-center md:text-left" style={{ padding: "30px" }}>Leroy Jenkins</h4>
              <p className="dark:text-gray-400" style={{ padding: "30px" }}>Sed non nibh iaculis, posuere diam vitae, consectetur neque. Integer velit ligula, semper sed nisl in, cursus commodo elit. Pellentesque sit amet mi luctus ligula euismod lobortis ultricies et nibh.</p>
            </div>
          </div>
        ...
        <div id="BODY">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-32">
              ...
              <div className="text-xl text-gray-700" style={{ textAlign: "center", marginTop: "20px" }}>Brought to you by your fellow immigrant buddies!</div>
              <StoriesPreview/>
            </div>
          </div>
        </div>
