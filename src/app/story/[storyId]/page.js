...
export default function StoryDetail({ params: { storyId } }) {
  ...
  return (
    <div className="relative isolate overflow-hidden bg-[#D2C6F7] px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        ...
        <div className="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]" aria-hidden="true">
          ...
          <svg
          className="absolute bottom-[max(10%,1rem)] bottom-0 h-[0rem] w-[0rem] -translate-x-1/2 stroke-gray-200 [mask-image:radial-gradient(32rem_32rem_at_top,white,transparent)]"
          aria-hidden="true"
        >
          <defs>
            <pattern
